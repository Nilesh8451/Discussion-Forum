...
<body>
    ...
    <div class="ques_tab">
        <div class='ques'>
	    <img src='<?php $x=$_GET['topic'];
		$z='.jpg';
		$tp=$x.$z;echo $tp;?>' width=100px height=100px class="center"><br><br>
        <h2 class='name'><?php echo $_GET['topic']?><br><br>
</div></div>
        <?php
         ...
         if($qresults>0)
         {
             while($row= mysqli_fetch_assoc($result))
             {
                ...
                echo '<div class="ans" color="#333333">'.$rowa['answer']. ' </div><div id="up"><br><button class="upbut"  id='.$rowa["aid"].'><i class="fa fa-thumbs-o-up w3-text-indigo" style="font-size:20px;"></i> Upvote</button></div><br><br> </div> </div>';
